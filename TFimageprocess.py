...
image_raw_data = tf.gfile.FastGFile(r"C:\Users\Qinchuan\PycharmProjects\TFimagedata_process\image\test.jpeg", 'rb').read()
###modify there according to Tensorflow 1.10
